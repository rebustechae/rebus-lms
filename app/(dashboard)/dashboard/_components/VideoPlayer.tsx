...
export default function VideoPlayer({
  ...
  return (
    ...
    >
      ...
      {/* Control Bar: Optimized for Touch (Mobile/Tablet) and Mouse (Desktop) */}
      <div className={`bg-slate-800 p-3 md:p-6 lg:p-8 space-y-4 md:space-y-6 ${isFullscreen ? "pb-12 pt-8 px-12" : ""}`}>
